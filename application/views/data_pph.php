				...
				<div class="col-md-9">
					...
					<div class="panel panel-green margin-bottom-40">
						<div class="panel-heading">
							<center><h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Data PPH Pasal 4,Ayat 2</h3></center>
						</div>
							...
							<table class="table table-striped" id="mytable">
								<thead>
									<tr>
										...
										<th><center>PPH Pasal 4,Ayat 2</center></th>
								...
								foreach($riwayat->result() as $row){ ?>
									<tr>
										...
										<td><center><?php echo $row->PPH?></center></td>
										<td>

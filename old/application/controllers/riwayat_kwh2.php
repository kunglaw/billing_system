...
class riwayat_kwh2 extends CI_Controller {

	public function index()
	{
		$data['riwayat']		= $this->db->query("select * from tb_riwayat2,ms_kwh where tb_riwayat2.No_ID = ms_kwh.No_ID order by tb_riwayat2.Date_Time desc");
		$this->load->view('data_riwayat2', $data);
	}
	...
	function export()
	{
		...
		$this->db->insert_batch('tb_riwayat2', $data);

		$this->session->set_flashdata('msg', 'success'); 

		redirect(base_url().'riwayat_kwh2');

			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="row tag-box tag-box-v5">
						...
						<form action="<?php echo base_url()?>riwayat_kwh2/export" method="post" class="sky-form" enctype="multipart/form-data">
						<div class="col-md-9">
					...
					<div class="panel panel-green margin-bottom-40">
						<div class="panel-heading">
							<center><h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Data Riwayat Waktu Beban Puncak</h3></center>
						</div>

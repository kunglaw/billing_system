...
<head>
	<title>Data BTU Consumption | Wisma Mulia 2</title>
		...
		<div class="container content profile">
			<div class="row">
				...
				<div class="col-md-9">
					...
					<!-- Start Import Data Consumption -->
					<div class="row tag-box tag-box-v5">
						
						<form action="<?php echo base_url()?>btukonsumsi/konsumsi" method="post" class="sky-form" enctype="multipart/form-data">
						<div class="col-md-9">
							<label for="file" class="input input-file">
									<div class="button"><input name="file" type="file">Browse</div><input placeholder="Import data excel Data Consumption" readonly="" type="text">
							</label>
						</div>
						<button type="submit" class="btn-u">Import Now! </button>
						</form>
					</div>
					<!--End Import Data Consumption-->
				
					<!--Start Table Consumption-->
					<div class="panel panel-green margin-bottom-40">
						<div class="panel-heading">
							<center><h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Data History BTU Consumption</h3></center>
						</div>

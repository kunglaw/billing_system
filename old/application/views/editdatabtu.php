...
<head>
	<title>Profile Page | Wisma Mulia 2</title>
			...
			<div class="row">
				...
				<div class="col-md-9">
					...
					<div class="row tag-box tag-box-v5">
						...
						<form action="<?php echo base_url()?>editbtu/export" method="post" class="sky-form" enctype="multipart/form-data">
						<div class="col-md-9">
					...
					<div class="panel panel-green margin-bottom-40">
						<div class="panel-heading">
							<center><h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Data History BTU Production</h3></center>
						</div>
